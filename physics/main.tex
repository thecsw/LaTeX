...
\begin{table}[h!]
    \begin{center}
      ...
      \begin{tabular}{c | c | c}
        \textbf{GlieseID} & \textbf{Absolute Magnitude} & \textbf{Abs. Magnitude (3sf)}\\
        \hline
...
Please note that I left the values of Bolometric Correction for White Dwarfs empty because I could not find the correct values for them. Maybe they do not even exist. To compensate the missing data, I will use the already available ratio of White Dwarfs' luminosity to the solar luminosity. \\
