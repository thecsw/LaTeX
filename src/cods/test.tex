...
\hypersetup{
 pdfauthor={Sagindyk Urazayev},
 pdftitle={Convergence of Divergent Series},
 pdfkeywords={},
 pdfsubject={},
...
service. Table \ref{tab:org8dc6ce7} will show first 10 non-zero elements' values
of Bernoulli numbers. 

\begin{table}[htbp]
\caption{\label{tab:org8dc6ce7}
